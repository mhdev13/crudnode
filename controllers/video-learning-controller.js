...
exports.createData = (req, res, next) => {
    ...
    const data = {...req.body};
    const querySql = 'INSERT INTO cms_video_learning SET ?';
...
exports.readData = (req,res,next) => {
    //buat query sql
    const querySql = "SELECT id,title,video,description,status,image_thumbnail,Thumbnail FROM cms_video_learning WHERE Status = 'Published'";
...
exports.updateData = (req,res,next) => {
    ...
    const data = { ...req.body};
    const querySearch = 'SELECT * FROM cms_video_learning WHERE id  = ?';
    const queryUpdate = 'UPDATE cms_video_learning SET ? WHERE id = ?';
...
exports.deleteData = (req, res, next) => {
    ...
    const querySearch = 'SELECT * FROM cms_video_learning WHERE id = ?';
    const queryDelete = 'DELETE FROM cms_video_learning WHERE id = ?';
