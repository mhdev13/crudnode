...
//insert Wordwall
exports.insertWordwall = (response,statement,data,next) => {
    //jalankan query
...
//get data Wordwall
exports.getWordwall = (response, statement, next) => {
    //jalankan query
...
//update data Wordwall
exports.updateWordwall = (response, searchStatement, updateStatement, id, data) => {
...
//delete Wordwall
exports.deleteWordwall = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
