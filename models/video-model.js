...
//insert Video
exports.insertVideo = (response,statement,data,next) => {
    //jalankan query
...
//get data Video
exports.getVideos = (response, statement, next) => {
    //jalankan query
...
//update data Video
exports.updateVideo = (response, searchStatement, updateStatement, id, data) => {
...
//delete Video
exports.deleteVideo = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
