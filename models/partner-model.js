...
//insert Partner
exports.insertPartner = (response,statement,data,next) => {
    //jalankan query
...
//get data Partner
exports.getPartners = (response, statement, next) => {
    //jalankan query
...
//update data Partner
exports.updatePartner = (response, searchStatement, updateStatement, id, data) => {
...
//delete Partner
exports.deletePartner = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
