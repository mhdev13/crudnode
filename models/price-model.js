...
//insert Price
exports.insertPrice = (response,statement,data,next) => {
    //jalankan query
...
//get data Price
exports.getPrices = (response, statement, next) => {
    //jalankan query
...
//update data Price
exports.updatePrice = (response, searchStatement, updateStatement, id, data) => {
...
//delete Price
exports.deletePrice = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
