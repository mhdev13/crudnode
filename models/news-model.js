...
//insert News
exports.insertNews = (response,statement,data,next) => {
    //jalankan query
...
//get data News
exports.getNews = (response, statement, next) => {
    //jalankan query
...
//update data News
exports.updateNews = (response, searchStatement, updateStatement, id, data) => {
...
//delete News
exports.deleteNews = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
