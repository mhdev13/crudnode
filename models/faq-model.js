...
//insert Faq
exports.insertFaq = (response,statement,data,next) => {
    //jalankan query
...
//get data Faq
exports.getFaqs = (response, statement, next) => {
    //jalankan query
...
//update data Faq
exports.updateFaq = (response, searchStatement, updateStatement, id, data) => {
...
//delete Faq
exports.deleteFaq = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
