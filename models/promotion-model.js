...
//insert Promotion
exports.insertPromotion = (response,statement,data,next) => {
    //jalankan query
...
//get data Promotion
exports.getPromotions = (response, statement, next) => {
    //jalankan query
...
exports.updatePromotion = (response, searchStatement, updateStatement, id, data) => {
...
//delete Promotion
exports.deletePromotion = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
