...
//insert Report
exports.insertReport = (response,statement,data,next) => {
    //jalankan query
...
//get data Report
exports.getReports = (response, statement, next) => {
    //jalankan query
...
//update data Report
exports.updateReport = (response, searchStatement, updateStatement, id, data) => {
...
//delete Report
exports.deleteReport = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
