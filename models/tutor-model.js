...
//insert Tutor
exports.insertTutor = (response,statement,data,next) => {
    //jalankan query
...
//get data Tutor
exports.getTutors = (response, statement, next) => {
    //jalankan query
...
//update data Tutor
exports.updateTutor = (response, searchStatement, updateStatement, id, data) => {
...
//delete Tutor
exports.deleteTutor = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
