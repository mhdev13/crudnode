...
//insert Mentor
exports.insertMentor = (response,statement,data,next) => {
    //jalankan query
...
//get data Mentor
exports.getMentors = (response, statement, next) => {
    //jalankan query
...
//update data Mentor
exports.updateMentor = (response, searchStatement, updateStatement, id, data) => {
...
//delete Mentor
exports.deleteMentor = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
