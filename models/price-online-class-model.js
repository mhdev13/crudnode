...
//insert Price
exports.insertPriceOnlineClass = (response,statement,data,next) => {
    //jalankan query
...
//get data Price
exports.getPricesOnlineClass = (response, statement, next) => {
    //jalankan query
...
//update data Price
exports.updatePriceOnlineClass = (response, searchStatement, updateStatement, id, data) => {
...
//delete Price
exports.deletePriceOnlineClass = (response, searchStatement, deleteStatement, id, next) => {
    //jalankan query untuk melakukan pencarian data
    koneksi.query(searchStatement, id, (err,rows,field) => {
        //error handling
        if(err){
