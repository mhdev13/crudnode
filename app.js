...
const priceOnlineClassRouter            = require('./routes/price-online-class-router');
...
const videoLearningRouter               = require('./routes/video-learning-router');
...
app.use('/api/price-online-class', priceOnlineClassRouter);
